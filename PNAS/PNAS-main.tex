...
Then we use the property that the average of log-quantities is the logarithm of the median quantity \cite{petroni2020gompertz}, where we denote the median of $F(t)$ as $M(t)$, 
\begin{equation}
\label{eq:medianGomp}
