...
\end{equation}
obtained with a second order expansion of the exponential term in (\ref{eq:SIRD_D}) and with $c=\eta\xi - \kappa$ and $K=2b/\eta\xi^2$. The SIR and SEIR model exhibits similar properties and their discrepancy with initial observations related to the Coronavirus epidemic has been noted by others \citep{vattay2020forecasting}.
