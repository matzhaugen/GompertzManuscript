...
\insertPngFig{order}{Exclusive interaction groups at each order: A) First order interaction, each entity is paired with a single other entity. B) Second order interaction, mutually exclusive groups of 2 entities interact with each other. B) Third order interaction, same as B) but for groups of three entities.} 
